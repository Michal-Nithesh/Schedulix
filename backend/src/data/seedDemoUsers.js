...
const demoUsers = [
	{ key: 'ADMIN', displayName: 'Administrator', role: 'ADMINISTRATOR', fallbackEmail: 'admin@timetable.demo', fallbackPassword: 'Admin@12345' },
	{ key: 'SCHEDULER', displayName: 'Scheduler', role: 'SCHEDULER', fallbackEmail: 'scheduler@timetable.demo', fallbackPassword: 'Scheduler@12345' },
	{ key: 'VIEWER', displayName: 'Viewer', role: 'VIEWER', fallbackEmail: 'viewer@timetable.demo', fallbackPassword: 'Viewer@12345' },
];
